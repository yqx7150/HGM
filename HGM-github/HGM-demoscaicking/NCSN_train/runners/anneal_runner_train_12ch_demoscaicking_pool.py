...
import grad_image as GI
import pool

#CUDA_VISIBLE_DEVICES=1 python3.5 separate_ImageNet.py --model ncsn --runner Anneal_runner_train_12ch_demoscaicking_pool --config anneal_MSR_12ch_pool.yml --doc MSR_12ch_pool
__all__ = ['Anneal_runner_train_12ch_demoscaicking_pool']
def show(image):
    plt.figure(1)
...
class Anneal_runner_train_12ch_demoscaicking_pool():
