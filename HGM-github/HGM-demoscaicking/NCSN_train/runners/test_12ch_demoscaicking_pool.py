...
#CUDA_VISIBLE_DEVICES=0 python3.5 separate_ImageNet.py --model ncsn --runner Test_12ch_demoscaicking_pool --config anneal.yml --doc MSR_12ch_pool --test --image_folder try_output_pool/Kodak_output

__all__ = ['Test_12ch_demoscaicking_pool']
...
def write_Data(result_all,i):
    with open(os.path.join('./try_output_pool/Kodak_output/',"psnr_Kodak"+".txt"),"w+") as f:
...
class Test_12ch_demoscaicking_pool():
