...
#CUDA_VISIBLE_DEVICES=1 python3.5 separate_ImageNet.py --model ncsn --runner anneal_runner_train_rgb --config anneal_bedroom_3ch.yml --doc bedroom_rgb_3ch_256_inpainter
__all__ = ['anneal_runner_train_rgb']
